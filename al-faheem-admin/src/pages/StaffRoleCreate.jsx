...
export default function StaffRoleCreate() {
  ...
  async function submit(e) {
    ...
    setBusy(true);
    try {
      await api.post('/admin/staff-roles', { name: name.trim(), description: description.trim() || null, isActive, permissions });
  ...
  return (
    <FormPage title={t('staffRoles.createTitle')} backTo="/staff-roles">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <Input
              ...
              placeholder={t('staffRoles.namePlaceholder')}
              value={name}
