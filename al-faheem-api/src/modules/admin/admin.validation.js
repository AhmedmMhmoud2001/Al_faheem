...
export const questionCreateSchema = z.object({
  ...
  optionAImageUrl: z.string().optional().nullable(),
  optionAImageUrlEn: z.string().optional().nullable(),
  optionB: z.string().min(1),
  optionBEn: z.string().optional().nullable(),
  optionBImageUrl: z.string().optional().nullable(),
  optionBImageUrlEn: z.string().optional().nullable(),
  optionC: z.string().min(1),
  optionCEn: z.string().optional().nullable(),
  optionCImageUrl: z.string().optional().nullable(),
  optionCImageUrlEn: z.string().optional().nullable(),
  optionD: z.string().min(1),
  optionDEn: z.string().optional().nullable(),
  optionDImageUrl: z.string().optional().nullable(),
  optionDImageUrlEn: z.string().optional().nullable(),
